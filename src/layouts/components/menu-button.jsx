  ...
  return (
    <IconButton sx={sx} {...other}>
      <SvgIcon>
        ...
        />
        <path
          d="M15.7798 10.75H5.2202C4.27169 10.75  3.5 11.3106     3.5  12.0004C3.5  12.6894  4.27169 13.25    5.2202 13.25H15.7798C16.7283 13.25  17.5 12.6894 17.5 12.0004C17.5 11.3105 16.7283   10.75  15.7798 10.75Z"
          fill="currentColor"
        />
        <path
